...
class ODCostMatrixAlgorithm(PlanXAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr(
            ...
            "Calculator; net_cost and the cutoff then work in the column's "
            "units. Values must be zero or positive and complete - NULL costs "
            "are read as 0, i.e. free segments. Each OD pair reports the "
