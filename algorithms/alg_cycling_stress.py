...
class CyclingStressAlgorithm(PlanXAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr(
            ...
            "- LTS speaks in people, not paint: LTS 1 = comfortable for "
            "children and seniors; LTS 2 = the 'interested but "
            "concerned' majority of adults - THE design target for a "
            "mass-cycling network; LTS 3 = confident riders only; "
            "LTS 4 = the strong and fearless few. A network is only as "
            "usable as the highest-stress link a trip must cross.\n"
            "- The share table's LTS 1-2 percentage is the headline, "
            "but geography beats percentage: 70 percent low-stress "
            "fabric cut into islands by LTS 4 arterials serves almost "
            "no whole trips - check with Low-Stress Islands.\n"
            "- Style by lts (green/yellow/orange/red): short red gaps "
            "in long green corridors are the highest-value fixes on "
            "the map.\n\n"
            "Using the results: rank interventions by stress RELIEF "
            "per metre - a 300 m protected link across an LTS 4 road "
            "often unlocks more trips than 3 km of paint on already "
            "calm streets; test a proposed lane by editing the infra "
            "field and rerunning; defend 30 km/h zones with the "
            "before/after LTS 1-2 share."
        )
